             ...
             <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<?php echo $msg ?>
                            <h2>
                                 MAXIMUM ORDER ON PAYMENT ON DELIVERY
                            </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                       <?php
			$userSelect = "SELECT * FROM tlbpdelivery  ";
	...
	?>
        <tr>
		   ...
		   <td><?php echo $location ?></td>
			...
			<!--<a href="" data-toggle="modal" data-target="<?php echo '#tlbpdelivery'.$eventPostId ?>">-->
			<a href="pod_update.php?id=<?php echo $eventPostId ?>"><span class="alert alert-primary" style="padding-top:5px; padding-bottom:5px; background-color:#000046; border-bottom:thick solid #000022; border-radius:2px;color:#fff;">Update</span></a>
