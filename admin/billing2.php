...
<body class="theme-red">
			...
			<th>Date</th>
             <th>Status</th>
                                    ...
                                    <tbody>
                                       <?php
									   $sn=0;
			$userSelect = "SELECT * FROM tlborder WHERE productType='Farmsales' ORDER BY id DESC";
 ...
 $Fetchedbal = $r["newBalance"];
	...
	?>
        ...
        <tr>
		 <td><?php echo $sn ?></td>
			...
			<?php echo "<strong>Total Price: &#8358;".number_format($eventTotalPrice)."</strong>" ?> <br><?php echo "<strong><font color=red>Wallet Bal: &#8358;".number_format($Fetchedbal)."</font></strong>" ?><br><?php echo "<strong>Delivery Location: $eventLocation</strong>" ?>  </p>
			...
			<strong><?php echo "Location: ".$eventLocation ?></strong><br/>
	...
	<div style="height:25px;"></div>
			<a onClick="confirm('Are You Sure Your Want To Confirm this Order: <?php echo $eventOrderId ?> ')" href="confirmOrder2.php?type=<?php echo base64_encode('tlborder')?>&ie=<?php echo base64_encode($eventPostId) ?>&ca=<?php echo base64_encode(confirm) ?>&it=<?php echo base64_encode($usertype)?>" ><span class="alert" style="padding-top:5px; padding-bottom:5px; border-bottom:3px #990000  solid; border-radius:2px; background-color: #CC0000; color:#fff;">Confirm</span></a>
				 
			 <?php } ?>
 			 
			<div style="height:25px;"></div>
 			<a onClick="confirm('Are You Sure Your Want To Delete this Order: <?php echo $eventOrderId ?> ')" href="order2_delete.php?type=<?php echo base64_encode('event')?>&ie=<?php echo base64_encode($eventPostId) ?>&ca=<?php echo base64_encode(delete) ?>&it=<?php echo base64_encode($userType)?>" ><span class="alert" style="padding-top:5px; padding-bottom:5px; border-bottom:3px #990000  solid; border-radius:2px; background-color: #990000; color:#fff;">Delete</span></a>
			<div style="height:25px;"></div>
 			 
			 <?php } ?>		
			 
			<!--<a href="" data-toggle="modal" data-target="<?php echo '#tlborder'.$eventPostId ?>">-->
			<a href="EditableInvoice/index2.php?orderid=<?php echo $eventOrderId ?>"><span class="alert alert-primary" style="padding-top:5px; padding-bottom:5px; background-color:#000046; border-bottom:thick solid #000022; border-radius:2px;color:#fff;">PrintInvoice</span></a>
			<div style="height:25px;"></div>
			
			 <?php if ($eventStatus=='ASSIGNED'){
		 ?>
			<div style="height:25px;"></div>
			<!--<a href="" data-toggle="modal" data-target="<?php echo '#tlborder'.$eventPostId ?>">-->
			<a href="van_assign1.php?id=<?php echo $eventPostId ?>"><span class="alert alert-primary" style="padding-top:5px; padding-bottom:5px; background-color:#990000; border-bottom:thick solid #990000; border-radius:2px;color:#fff;">ReAssignVan</span></a>
			
			 <?php }else{ ?>	
			 <div style="height:25px;"></div>
			<!--<a href="" data-toggle="modal" data-target="<?php echo '#tlborder'.$eventPostId ?>">-->
			<a href="van_assign1.php?id=<?php echo $eventPostId ?>"><span class="alert alert-primary" style="padding-top:5px; padding-bottom:5px; background-color:#000046; border-bottom:thick solid #000022; border-radius:2px;color:#fff;">AssignVan</span></a>
			<?php } ?>	
			</td>
            <!--<td></td>-->
