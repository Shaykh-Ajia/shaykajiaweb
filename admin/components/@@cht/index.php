...
function loginForm() {
	...
	<th class="nav" align="center"><img src="images/logo.png"  ></th>
	<strong><marquee behavior="alternate">MILE12 CONNECT  - LIVE CHAT </marquee></span></font></div></strong>
	</br></br><a href="../../dashboard.php">Goto Dashboard</a>
		<div id="loginform">
			<form action="index.php" method="post">
			<h1>Mile12 Connect Chat</h1><hr/>
...
<html>
<head>
	<title>Mile12 Connect Live Chat</title>
...
<form name="message" action="">
	<input name="usermsg" class="form-control" type="text" id="usermsg" placeholder="Start Chat" />
...
setInterval (loadLog, 60);
</script>
<?php
}
?>
</body>
<p><Strong><center> Mile12 Connect - Live Chat</center></Strong></p>
