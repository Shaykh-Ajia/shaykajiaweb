...
$author = $eventChckF['author'];
 		$del1 = "DELETE FROM mainacc WHERE id = '$eventPostId' ";
		 
		 
		if($delQ = mysqli_query($conStr,$del1 ))
		{ 
			 
				$msg="<div class='alert alert-success'><h4>Payment Successfully DELETED!</h4></div>";
...
?>
<meta http-equiv="refresh" content="2; url=account_view.php" />
