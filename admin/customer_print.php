	   ...
	   ?>
           ...
           <th>Action</th>
                                    ...
                                    <tbody>
                                       <?php
									   $sn=0;
			$userSelect = "SELECT * FROM  questions  ";
...
<source src=" <?php echo $eventBanner ?>" type="audio/mpeg">
</audio>
           </td>
            <?php if($status=='unanswered'){
            ?>
             <td><span class="label bg-red"> <?php echo $status ?></span></td>
             <?php
            }else{
                ?>
            <td><span class="label bg-green"> <?php echo $status ?></span></td>
            <?php
            } ?>
		 ...
		 ?>
			...
			<!--<a href="" data-toggle="modal" data-target="<?php echo '#questions'.$eventPostId ?>">-->
			<a href="customer_update.php?id=<?php echo $eventPostId ?>"><span class="alert alert-primary" style="padding-top:5px; padding-bottom:5px; background-color:#000046; border-bottom:thick solid #000022; border-radius:2px;color:#fff;">Reply</span></a>
 			 
			 <?php } ?>

			<div style="height:25px;"></div>
 			<a onClick="confirm('Are You Sure Your Want To Delete this Question: <?php echo $title ?> ')" href="customer_delete.php?type=<?php echo base64_encode('userlogin')?>&ie=<?php echo base64_encode($eventPostId) ?>&ca=<?php echo base64_encode(delete) ?>&it=<?php echo base64_encode($userType)?>" ><span class="alert" style="padding-top:5px; padding-bottom:5px; border-bottom:3px #990000  solid; border-radius:2px; background-color: #990000; color:#fff;">Delete</span></a>
			 <?php } ?>				
			</td>
            <!--<td></td>-->
        </tr>
