                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                         ...
                         <div class="header">
                            <h2>ADD EXPENSES</h2><p>
                            
                        </div>
                        <div class="body">
                            <form id="form_validation" method="post" action="expenses_added.php" enctype="multipart/form-data">
                               
	  <div class="form-group">
                                <div class="col-md-12">
                                    
                                    <select class="form-control show-tick" name="expenses_type">
									<option>Select Expenses Type</option>
                                        <?php
      
$schoolid=$_SESSION["schoolid"];
      
 $query = "SELECT * FROM expensetype WHERE schoolid='$schoolid'";
 ...
 $Fetchedaccounttype = $r["expense_type"];
...
?>
								...
								<a href="expensestype_add.php">Add more ExpensesType...</a>
								</div> 	
