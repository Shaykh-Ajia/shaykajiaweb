                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                         ...
                         <div class="header">
                            <h2>ADD OTHER MARKET</h2><p>
                            
                        </div>
                        <div class="body">
                            <form id="form_validation" method="post" action="othermarket_added.php" enctype="multipart/form-data">
                              
								  
                                <div class="form-group form-float">
                                    <div class="form-line">
									 
                                        <input type="text" class="form-control" name="marketName" id="marketName" required>
                                         <label class="form-label">OtherMarket Name:</label>
                                    </div>
                                </div>                                 
								  
                            <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="store_owner" id="store_owner"  >
                                        <label class="form-label">Store Owner's Name:</label>
                                    </div>
                                </div>
                           ...
                           <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        ...
                                        <label class="form-label">Selling Product</label>
                                    </div>
                                </div>
