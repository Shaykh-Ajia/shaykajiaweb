...
Your Order is being Processed.
 ...
 mail($to, $subject, $message, $headers); 		
				...
				$msg= "<div class='alert alert-danger'>Sorry! your Order is more than Max. Amt for Pay on Delivery Order<br>Total No of Farm Sales =$total2<br>Minimum Order Quantity(MOQ)=$lastqty</div>
