...
$userLogId = $_SESSION['login_id'];
$userInfo = "SELECT * FROM vandb WHERE id = '$userLogId'";
$userInfoQ = mysqli_query($conStr,$userInfo);
$userInfoF = mysqli_fetch_array($userInfoQ,MYSQLI_ASSOC);
$id = $userInfoF['id'];
$fullname = $userInfoF['fullname'];
$eMail = $userInfoF['email'];
$vehicle_type = $userInfoF['vehicle_type'];

$phone = $userInfoF['phoneno'];
$brand = $userInfoF['brand'];
$profilePics = $userInfoF['passport'];
$profilePics1 = $userInfoF['vehicle_picture'];
$customer_class = $userInfoF['customer_class'];
$address = $userInfoF['address'];
$model = $userInfoF['model'];
$username = $userInfoF['username'];
$password = $userInfoF['password'];
    ...
    <section class="content">
	  ...
	  // include("components/transactionBadge.php");
	   ?>
		...
		BASIC INFORMATION &nbsp;&nbsp; / &nbsp;&nbsp; <span style="color:#006600; font-weight:bold;">Edit Profile</span> &nbsp;&nbsp;&nbsp;<small><em>&laquo;<a href="<?php echo "staff1_update.php?id=$userLogId" ?>">Click To Edit Profile</a></em></small>
				</div>
		...
		<p>
		 ...
		 <div class="card-header" style="padding-left:0px; padding-top: 0px 0px;">
		   <p align="center"> <center><img src="<?php echo $profilePics ?>" width="250px" height="250px"></center>  
		    <p align="center"> <center> <?php echo "PROFILE PICTURE"; ?> </center>  
		   
				</div>
				</div>
					<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12" style="border:thin solid #CCCCCC;">
		 <div class="card-header" style="padding-left:0px; padding-top: 0px 0px;">
		   <p align="center"> <center><img src="<?php echo $profilePics1 ?>" width="300px" height="200px"></center>  
		    
		    <p align="center"> <center> <?php echo "VEHICLE PICTURE"; ?> </center>  
				</div>
				</div>
