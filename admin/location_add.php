                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                         ...
                         <div class="header">
                            <h2>ADD LOCATION AND AMOUNT</h2>
                           
                        </div>
                        <div class="body">
                            <form id="form_validation" method="post" action="location_added.php">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="location" required>
                                        <label class="form-label">Location(e.g Gbagada)</label>
                                    </div>
                                </div>
                                  <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="amount" required>
                                        <label class="form-label">Amount(e.g 1000)</label>
                                    </div>
                                </div>
