                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                       <?php
			$userSelect = "SELECT * FROM transport WHERE schoolid='$schoolid'";
			$userSelectQ = mysql_query($userSelect);
			while($userSelectF = mysql_fetch_array($userSelectQ))
			{
				$eventPostId = $userSelectF ['id'];
				$studentname = $userSelectF['studentname'];
				$drivername = $userSelectF['drivername'];
				$driverno = $userSelectF['drivernumber'];
				$arrivaltime = $userSelectF['arrivaltime'];
				$route = $userSelectF['route'];
	...
	?>
        <tr>
		 ...
		 ?>
			...
			<!--<a href="" data-toggle="modal" data-target="<?php echo '#transport'.$eventPostId ?>">-->
			<a href="transport_update.php?id=<?php echo $eventPostId ?>"><span class="alert alert-primary" style="padding-top:5px; padding-bottom:5px; background-color:#000046; border-bottom:thick solid #000022; border-radius:2px;color:#fff;">Update</span></a>
 			 
			
 			<a onClick="confirm('Are You Sure Your Want To Delete this Student from  Transport: <?php echo $studentname ?> ')" href="transport_delete.php?type=<?php echo base64_encode('transport')?>&ie=<?php echo base64_encode($eventPostId) ?>&ca=<?php echo base64_encode(delete) ?>&it=<?php echo base64_encode($userType)?>" ><span class="alert" style="padding-top:5px; padding-bottom:5px; border-bottom:3px #990000  solid; border-radius:2px; background-color: #990000; color:#fff;">Delete</span></a>
			 <?php } ?>				
			</td>
            <!--<td></td>-->
        </tr>
