...
$date=date("d/m/Y");
$status = "Pending";
 $productType="Farmsales";
$total2 =  $_SESSION["total2"];
$lastqty =  $_SESSION["lastqty"];
if($total2>=$lastqty){
if($walletbal>=$total){
    ...
    foreach ($_SESSION["cart_item"] as $item){
				$line_total=$item["price"] * $item["quantity"];
					$line_total2=$item["amt_saved"] * $item["quantity"];
	...
	$description="PAYMENT FOR THE ITEMS ON THE MILE12 CONNECT";
	...
	$to = "$eMail,lifestyle@mile12connect.com";     //Change to your email address here    
      $subject = "Farm Sales Order Notification";
...
Your Order is being Processed.
 ...
 mail($to, $subject, $message, $headers); 		
				...
				$msg= "<div class='alert alert-success'>Order Processed Successfully... <br>Total No of Farm Sales =$total2<br>Minimum Order Quantity(MOQ)=$lastqty </div>
				
				<center><img src=complete.png>
				";
		}else{
		 
				$msg= "<div class='alert alert-danger'>Insufficient Fund! - Please fund your Wallet to place Order<br>Total No of Farm Sales =$total2<br>Minimum Order Quantity(MOQ)=$lastqty</div>
				...
				$msg= "<div class='alert alert-danger'>Sorry! You have not reach the MOQ  per Customer<br>Total No of Farm Sales Selected = $total2<br>Minimum Order Quantity(MOQ)=$lastqty
