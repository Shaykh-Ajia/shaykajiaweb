                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                       <?php
									   $sn=0;
			$userSelect = "SELECT * FROM list_rec order by id Desc";
	...
	?>
        <tr>
		 ...
		 ?>
			...
			<!--<a href="" data-toggle="modal" data-target="<?php echo '#list_rec'.$eventPostId ?>">-->
			<a href="reply.php?id=<?php echo $eventPostId ?>"><span class="alert alert-primary" style="padding-top:5px; padding-bottom:5px; background-color:#000046; border-bottom:thick solid #000022; border-radius:2px;color:#fff;">Reply</span></a>
