	  ...
	  // include("components/transactionBadge.php");
	   ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                       <?php
									   $sn=0;
			$userSelect = "SELECT * FROM tlbinvoice WHERE companyid='$schoolid' group by invoiceno";
			...
			while($userSelectF = mysqli_fetch_array($userSelectQ,MYSQLI_ASSOC))
			{
				...
				$plateno = $userSelectF['plate_no'];
				$invoiceno = $userSelectF['invoiceno'];
	...
	?>
        <tr>
		 ...
		 ?>
			...
			<a href="EditableInvoice/index.php?invoiceno=<?php echo $invoiceno ?>"><span class="alert alert-primary" style="padding-top:5px; padding-bottom:5px; background-color:#000046; border-bottom:thick solid #000022; border-radius:2px;color:#fff;">PrintInvoice</span></a>
