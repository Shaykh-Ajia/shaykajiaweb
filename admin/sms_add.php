            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="post" action="sms_added.php" enctype="multipart/form-data">
                              
								  <div class="form-group form-float">
                                <div class="col-md-12">
                                    <label class="col-md-6 control-label">Recipient Category</label>
                                    <select class="form-control show-tick" name="category">
									<option>Select Recipient</option>
                                       <option>Teaching Staff</option>
										<option>Parent</option>
    									<option>Non-Teaching </option>                                    </select>

                                </div></div> 					 
                               		  <div class="form-group form-float">
                                    <div class="form-line">
									<label class="col-md-2 control-label">Sender ID:</label>
                                        <input type="text" class="form-control" name="senderid" required>
                                    ...
                                    <div class="form-line">
									 <label class="col-md-2 control-label">PhoneNo</label>
                                        <textarea name="phoneno" cols="30" rows="5" class="form-control no-resize" required></textarea>
