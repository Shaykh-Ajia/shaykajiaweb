...
$acct_no = $_SESSION['cust_id'];
		$password=$_SESSION["password"];
			//$studentid=$_SESSION["studentid"]	;
			$schoolid=$_SESSION["schoolid"]; 
 $query = "SELECT * FROM userinfo WHERE cust_id='$acct_no' ";
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                         ...
                         <div class="header">
                            <h2>CHANGE CUSTOMER TYPE</h2>
                           
                        </div>
                        <div class="body">
                            <form id="form_validation" method="post" action="class_reset.php">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="acct_no"  value="<?php echo  $acct_no ?>" required>
                                        
                                    </div>
                                </div>
                                <div class="form-group form-float" style="width:150px">
                                    <div class="form-line">
                                       <select class="form-control show-tick" name="newclass">
