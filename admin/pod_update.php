...
//$c_Z = mysqli_query($conStr,"SELECT * FROM tlbpdelivery WHERE id = '$id' ");
//$r_Z = mysqli_fetch_array($c_Z);
//extract($r_Z);
$userSelect = "SELECT * FROM tlbpdelivery WHERE id = '$id'";
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="post" action="pod_updated.php">
