...
//$c_Z = mysqli_query("SELECT * FROM tlblocation WHERE id = '$id' ");
//$r_Z = mysqli_fetch_array($c_Z,MYSQLI_ASSOC);
//extract($r_Z);
$userSelect = "SELECT * FROM tlblocation WHERE id = '$id'";
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="post" action="location_updated.php">
