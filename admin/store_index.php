...
<body class="theme-red">
	  ...
	  // include("components/transactionBadge.php");
	   ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                       <?php
									   $sn=0;
			$userSelect = "SELECT * FROM othermarket  ";
			...
			while($userSelectF = mysqli_fetch_array($userSelectQ,MYSQLI_ASSOC))
			{
				...
				$industry = $userSelectF['industry'];
				 
				$fullname = $userSelectF['fullname'];
				$address = $userSelectF['address'];
				 $phoneno = $userSelectF['phoneno'];
			 $product_sales = $userSelectF['product_sales'];
	...
	?>
        <tr>
		   ...
		   <td><?php echo $product_sales ?></td>
          		<td>
			  
			 
			 
			<!--<a href="" data-toggle="modal" data-target="<?php echo '#othermarket'.$eventPostId ?>">-->
			<a href="store_update.php?id=<?php echo $eventPostId ?>"><span class="alert alert-primary" style="padding-top:5px; padding-bottom:5px; background-color:#000046; border-bottom:thick solid #000022; border-radius:2px;color:#fff;">Update</span></a>
 			 
			<div style="height:25px;"></div>
 			<a onClick="confirm('Are You Sure Your Want To Delete this Store: <?php echo $industry ?> ')" href="store_delete.php?type=<?php echo base64_encode('othermarket')?>&ie=<?php echo base64_encode($eventPostId) ?>&ca=<?php echo base64_encode(delete) ?>&it=<?php echo base64_encode($userType)?>" ><span class="alert" style="padding-top:5px; padding-bottom:5px; border-bottom:3px #990000  solid; border-radius:2px; background-color: #990000; color:#fff;">Delete</span></a>
