...
$newMemberId = "SELECT * FROM $type WHERE id='$eventPostId'";
      ...
      $subject = "VAN DELIVERY CONFIRMATION";
...
The Delivery of $fullname has been Done.
 ...
 mail($to, $subject, $message, $headers); 	
	...
	$msg = "<div class='alert alert-success'>Delivery Confirmation Successful</div>";
	 
		include("billing5.php");
 
	 
	 
?>
<meta http-equiv="refresh" content="0; url=billing5.php" />