...
$userSelect = "SELECT * FROM lectures where id='$id' ";
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="post" action="info_updated.php">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
									 <label class="col-md-2 control-label">Url</label>
                                        <input type="text" class="form-control" name="url"  value="<?php echo $eventBanner ?>"  >
