                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                         ...
                         <div class="header">
                            <h2>ADD EXPENSES TYPE</h2>
                           
                        </div>
                        <div class="body">
                            <form id="form_validation" method="post" action="expensestype_added.php">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="exptype" required>
                                        <label class="form-label">Expenses Type (e.g Salary)</label>
                                    </div>
                                </div>
